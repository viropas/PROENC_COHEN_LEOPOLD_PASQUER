...
```{r}
dataframe <- read.table("kmer_out.histo") #load the data into dataframe
...
```{r}
sc_begin <- 7 # estimated by observing the curve
sc_end <- 70 # estimated by observing the curve
