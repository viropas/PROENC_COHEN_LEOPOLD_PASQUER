...
```{r}
dataframe <- read.table("kmer_short_out.histo") #load the data into dataframe
...
print(paste("Total number of kmer =", k_mer))
```
...
```{r}
sc_begin <- 17 # estimated by observing the curve
sc_end <- 120 # estimated by observing the curve
