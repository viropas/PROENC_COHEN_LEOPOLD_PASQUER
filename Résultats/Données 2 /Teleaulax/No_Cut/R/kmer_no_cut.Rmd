...
```{r}
dataframe <- read.table("21mer_no_cut.histo") #load the data into dataframe
...
```{r}
sc_begin <- 18 # estimated by observing the curve
sc_end <- 60 # estimated by observing the curve
